...
class Payment implements \JsonSerializable
{
     ...
     * @param array $split
     *
     * @example Como enviar corretamente o array
     * Array (
     *   {
     *      "recipient": "1d71c944b96a43b39c2b38fd6353b6a2",
     *      "liable": "true",
     ...
     * )
     * @description
     *   - recipient : Identificador do seller recebedor
     *   - liable : define se o recebedor arca com prejuízo em caso de
     *   chargeback ou não. true arca; false não arca.
     *   - charge_processing_fee : define se vai ser feito split em cima do
     *   valor bruto (false) ou do valor líquido (true) da transação
     *   - percentage : percentual da venda a ser splitado.
     *   - amount : valor em centavos a ser splitado.
     * @return $this
     */
